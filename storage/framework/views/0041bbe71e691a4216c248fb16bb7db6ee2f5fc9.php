...
<div class="container create-container">
    ...
    <form action="<?php echo e(route("logged.store")); ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="row check">
            <div class="form-group col-lg-3 col-md-6">
                ...
                <select name="check_in" id="check_in" class="form-control">
                    ...
                    <?php for($i = 0; $i < 24; $i++): ?> <option value="<?php echo e($i); ?>"> <?php echo e($i > 9 ? $i : '0' . $i); ?>:00 </option>
                        <?php endfor; ?>
                </select>
            </div>
            ...
            <div class="form-group col-lg-3 col-md-6">
                ...
                <select name="check_out" id="check_out" class="form-control">
                    <option value="" seletced> Scegli orario </option>
                    <?php for($i = 0; $i < 24; $i++): ?> <option value="<?php echo e($i); ?>"> <?php echo e($i); ?>:00 </option>
                        <?php endfor; ?>
                </select>
            </div>
        </div>
            ...
            <div class="row services">
                ...
                <div class="col-lg-4">
                    <label for="<?php echo e($service->title); ?>">
                        <input type="checkbox" name="services[]" value="<?php echo e($service->id); ?>" id="<?php echo e($service->title); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\asky_\OneDrive\Desktop\project\boolbnb\resources\views/logged/accomodation/create.blade.php ENDPATH**/ ?>