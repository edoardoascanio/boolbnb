    ...
    <form @submit.prevent="filterData" class="flex-wrap " id="searchForm" >
        <div class="d-flex filters-container align-items-center">
            <div class="input-search-map d-flex flex-column">
                ...
                <input class="" type="text" placeholder="Scegli la Città" id="city" value="<?php echo e($city['city']); ?>">
            </div>
            <div class="input-search-map d-flex flex-column">
                <label for="beds" class="forma-label mb-0">Letti</label>
                <input type="text" placeholder="Es. 1" id="beds" value="<?php echo e($number_beds['number_beds']); ?>">
            </div>
            <div class="input-search-map d-flex flex-column">
            ...
            <div>
                ...
                <div id="service-list" style="display: none">
                    ...
                    <label for="<?php echo e($service->id); ?>">
                        <input type="checkbox" id="<?php echo e($service->id); ?>" class="services" value="<?php echo e($service->id); ?>"
                            name="service">
...
<?php echo $__env->make('layouts.mapLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\asky_\OneDrive\Desktop\project\boolbnb\resources\views/guest/accomodation/map.blade.php ENDPATH**/ ?>